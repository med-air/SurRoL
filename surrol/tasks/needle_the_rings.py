...
class NeedleRings(PsmsEnv):
    ...
    def _env_setup(self):
        ...
        startOrientation = p.getQuaternionFromEuler([1.57,0,1.57])
        ring_cyl00 = p.loadURDF(os.path.join(ASSET_DIR_PATH, "ring_cyl/ring_cyl.urdf"),[2.65,-0.1,3.42],startOrientation,globalScaling=0.025,useFixedBase=1)
        ring_cyl01 = p.loadURDF( os.path.join(ASSET_DIR_PATH, "ring_cyl/ring_cyl.urdf"),[2.65,0,3.42],startOrientation,globalScaling=0.025,useFixedBase	=1)
        ring_cyl02 = p.loadURDF( os.path.join(ASSET_DIR_PATH, "ring_cyl/ring_cyl.urdf"),[2.65,0.1,3.42],startOrientation,globalScaling=0.025,useFixedBase	=1)
        # ring_cyl10 = p.loadURDF( os.path.join(ASSET_DIR_PATH, "ring_cyl/ring_cyl.urdf"),[2.6,-0.1,3.42],startOrientation,globalScaling=0.02,useFixedBase	=1)
        # ring_cyl11 = p.loadURDF( os.path.join(ASSET_DIR_PATH, "ring_cyl/ring_cyl.urdf"),[2.6,0,3.42],startOrientation,globalScaling=0.02,useFixedBase	=1)
        # ring_cyl12 = p.loadURDF( os.path.join(ASSET_DIR_PATH, "ring_cyl/ring_cyl.urdf"),[2.6,0.1,3.42],startOrientation,globalScaling=0.02,useFixedBase=1)
        ring_cyl10 = p.loadURDF( os.path.join(ASSET_DIR_PATH, "ring_cyl/ring_cyl_yellow.urdf"),[2.85,-0.1,3.42],startOrientation,globalScaling=0.025,useFixedBase	=1)
        ring_cyl11 = p.loadURDF( os.path.join(ASSET_DIR_PATH, "ring_cyl/ring_cyl_yellow.urdf"),[2.85,0,3.42],startOrientation,globalScaling=0.025,useFixedBase	=1)
        ring_cyl12 = p.loadURDF( os.path.join(ASSET_DIR_PATH, "ring_cyl/ring_cyl_yellow.urdf"),[2.85,0.1,3.42],startOrientation,globalScaling=0.025,useFixedBase=1)
        ...
        obj_id = p.loadURDF(os.path.join(ASSET_DIR_PATH, 'needle/needle_40mm.urdf'),
                            ...
                            useFixedBase=False,
                            globalScaling=self.SCALING*0.4)
