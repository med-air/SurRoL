...
from surrol.tasks.psm_env_RAL import PsmEnv
...
class NeedlePickRAL(PsmEnv):
    ...
    def __init__(self, render_mode=None, cid = -1):
        super(NeedlePickRAL, self).__init__(render_mode, cid)
    ...
    def _env_setup(self):
        super(NeedlePickRAL, self)._env_setup()
        ...
        # tray pad
        obj_id = p.loadURDF(os.path.join(ASSET_DIR_PATH, 'tray_RAL/tray_pad.urdf'),
        ...
        obj_id = p.loadURDF(os.path.join(ASSET_DIR_PATH, 'needle_RAL/needle_40mm.urdf'),
...
if __name__ == "__main__":
    env = NeedlePickRAL(render_mode='human')  # create one process and corresponding env
