    ...
    def _env_setup(self):
        ...
        for i in range(2):
            ...
            for j in range(6):
                ...
                ring = p.loadURDF(os.path.join(ASSET_DIR_PATH,"ring/newring.urdf"),upper_pos,startOrientation,globalScaling=scaling)
        ...
        self.obj_id, self.obj_link1 = self._rings[0], 0
